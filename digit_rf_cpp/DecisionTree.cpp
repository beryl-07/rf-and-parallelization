...
//  */
// void DecisionTree::draw_tree() const {
//     std::cout << "Arbre de décision :" << std::endl;
//     draw_node(root, 0);
// }
...
//  */
// void DecisionTree::draw_node(const Node* node, int depth) const {
//     if (!node) return;
//     for (int i = 0; i < depth; ++i) std::cout << "  ";
//     if (!node->left && !node->right) {
//         std::cout << "[Feuille] Classe: " << node->label << std::endl;
//     } else {
//         std::cout << "[Noeud] x" << node->feature << " == " << node->value << std::endl;
...
//  */
// void DecisionTree::export_dot(const std::string& filename) const {
//     std::ofstream out(filename);
//     out << "digraph DecisionTree {" << std::endl;
//     write_dot(root, out, 0);
//     out << "}" << std::endl;
// }
...
//  */
// int DecisionTree::write_dot(const Node* node, std::ostream& out, int node_id) const {
//     if (!node) return node_id;
//     int current_id = node_id;
//     if (!node->left && !node->right) {
//         out << "  node" << current_id << " [label=\"Classe: " << node->label << "\", shape=box, style=filled, color=lightblue];" << std::endl;
//     } else {
//         out << "  node" << current_id << " [label=\"x" << node->feature << " == " << node->value << "\", shape=ellipse, style=filled, color=lightgray];" << std::endl;
//         if (node->left) {
//             int left_id = node_id + 1;
//             out << "  node" << current_id << " -> node" << left_id << " [label=\"Oui\"]" << ";" << std::endl;
//             int next_id = write_dot(node->left, out, left_id);
//             if (node->right) {
//                 int right_id = next_id;
//                 out << "  node" << current_id << " -> node" << right_id << " [label=\"Non\"]" << ";" << std::endl;
//                 return write_dot(node->right, out, right_id + 1);
//             } else {
//                 return next_id;
//             }
//         } else if (node->right) {
//             int right_id = node_id + 1;
//             out << "  node" << current_id << " -> node" << right_id << " [label=\"Non\"]" << ";" << std::endl;
//             return write_dot(node->right, out, right_id);
//         }
//     }
//     return node_id + 1;
// }
